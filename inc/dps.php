<?php
/**
 * Display Posts Shortcode plugin extras.
 *
 ...
 */
function lcm_dps_template_part( $output, $original_atts ) {
...
add_action( 'display_posts_shortcode_output', 'lcm_dps_template_part', 10, 2 );